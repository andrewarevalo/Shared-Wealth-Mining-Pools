...
You will implement two separate classes: PropPoolOperator and PplnsPoolOperator, both of which will extend the PoolOperator class.

The methods you will need to override:
1) rewardMiner -- change this to track which miners found "shares"
2) payRewards -- change this method to pay out rewards to the miners who found shares, according to the different mining pool designs.
